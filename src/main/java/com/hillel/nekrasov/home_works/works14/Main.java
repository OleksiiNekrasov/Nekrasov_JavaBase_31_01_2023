...
public class Main {
    public static void main(String[] args) {
        ...
        FitnessUser user1 = new FitnessUser("John", birthday1, "john@example.com", "123456", "Doe", 80, 120, 10000);

        LocalDate birthday2 = LocalDate.of(1988, 7, 22);

        FitnessUser user2 = new FitnessUser("Jane", birthday2, "jane@example.com", "654321", "Doe", 60, 110, 8000);
